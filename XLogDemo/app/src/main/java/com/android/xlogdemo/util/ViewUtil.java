...
public class ViewUtil {
    ...
    /**
     * set SwitchButton checked
     * @param switchButton
     * @param checked
     */
/*    public static void checked(SwitchButton switchButton,boolean checked){
		if(null==switchButton){
			return;
		}

		if(true==checked){
			if(true!=switchButton.isChecked()){
				switchButton.setChecked(true);
			}
		}else{
			if(false!=switchButton.isChecked()){
